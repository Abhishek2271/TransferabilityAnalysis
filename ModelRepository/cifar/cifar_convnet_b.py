...
A higher capacity version of Cifar10 base model defined in cifar_covnet.py
    ...
    def build_graph(self, image, label):
        ...
        with argscope(Conv2D, activation=BNReLU, use_bias=False, kernel_size=3), \
            ...
            logits = LinearWrap(image) \
                ...
                .Conv2D('conv3.1', filters=256) \
                .Conv2D('conv3.2', filters=256, padding='VALID') \
                .Conv2D('conv3.3', filters=256, padding='VALID') \
